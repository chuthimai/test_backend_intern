"""
Django settings for test_backend_intern project.
...
INSTALLED_APPS = [
    ...
    'crm_system',
    'rest_framework_simplejwt.token_blacklist',  # Thêm blacklist để thu hồi token
    'drf_spectacular',
...
ROOT_URLCONF = 'test_backend_intern.urls'
...
WSGI_APPLICATION = 'test_backend_intern.wsgi.application'
